...
# # game_data_path = f"data/game_data/{GAME_ID}/game1_latest.json"
...
# # os.makedirs(f"data/game_data/{GAME_ID}/memory", exist_ok=True)
...
#     import google.generativeai as genai
#     genai.configure(api_key=GOOGLE_API_KEY)
#     MODEL = genai.GenerativeModel(model_name="gemini-1.5-pro-latest", generation_config=model_config, safety_settings=safety_settings)
#     FAST_MODEL = genai.GenerativeModel(model_name="gemini-1.5-flash-latest", generation_config=creative_config, safety_settings=safety_settings)
